...
getPackageJson("./../..", function (f, s) {
  ...
  if (isPackageJson != null) {
    ...
    if (/configureReactBackHome/.test(rf)) {
      return;
    }

    if (searchKey != null) {
      rf = rf.replace(searchKey[0], searchKey[0] + "    \"configureReactBackHome\"\: \"node node_modules\/react-back-home\/configureReactBackHome\.js\"\,\n");
